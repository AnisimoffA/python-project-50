...
def test_flatten_jaml():
    needed_diff_stylish = diff_gen.generate_diff("flatten_before.json","flatten_after.json", stylish)  # noqa: E501
    needed_diff_plain = diff_gen.generate_diff("flatten_before.json","flatten_after.json", plain)
    needed_diff_json_format = diff_gen.generate_diff("flatten_before.json","flatten_after.json", json_format)
